...
{
    public class DataApiOAuth2AuthenticationHandler : AuthenticationHandler<DataApiOAuth2AuthenticationOptions>
    {
        private static string TokenEndpoint = AppSettings.TokenUrl;
        private static string UserInfoEndpoint = AppSettings.MeUrl;
        private static string AuthorizeEndpoint = AppSettings.AuthorizeUrl;

        private readonly ILogger _logger;
        private readonly HttpClient _httpClient;

        public DataApiOAuth2AuthenticationHandler(HttpClient httpClient, ILogger logger)
        {
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                var context = new DataApiOAuth2AuthenticatedContext(Context, user, accessToken, refreshToken, expires);
        ...
        protected override Task ApplyResponseChallengeAsync()
        {
            ...
            if (challenge != null)
            {
                ...
                var redirectContext = new DataApiOAuth2ApplyRedirectContext(
                    Context, Options,
        ...
        private async Task<bool> InvokeReplyPathAsync()
        {
            if (Options.CallbackPath.HasValue && Options.CallbackPath == Request.Path)
            {
                ...
                var context = new DataApiOAuth2ReturnEndpointContext(Context, ticket);
